...
<body class="">
    ...
    <div class="flex flex-col-reverse h-64 lg:flex-col justify-end lg:justify-start lg:h-full fixed bg-semidarkgrey lg:w-64 w-screen pt-32 top-0 z-10">
        <div class="">
        ...
        <div class="flex flex-row lg:flex-col items-center justify-around my-4">
            <h3 class=" text-2xl text-white font-semibold">Catégorie:</h3>
